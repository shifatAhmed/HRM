...
class PaymentSmsTest extends TestCase
{
    ...
    public function test_it_rejects_a_payment_that_is_greater_than_the_invoice_due_amount(): void
    {
        $user = User::factory()->create();
        $building = Building::create(['name' => 'Building A', 'address' => 'Dhaka']);
        $flat = Flat::create([
        ...
        $response->assertSessionHasErrors([
            'amount' => 'Payment cannot be greater than the remaining due amount of ৳5,000.00.',
        ]);
